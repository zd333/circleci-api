 ...
 */
export declare function getCheckoutKeys(token: string, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<CheckoutKeyResponse>;
/**
 ...
 */
export declare function createCheckoutKey(token: string, key: CheckoutKey, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<CheckoutKeyResponse>;
/**
 ...
 * @returns list of checkout keys for a specific project
 */
export declare function getCheckoutKey(token: string, fingerprint: string, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<CheckoutKeyResponse>;
/**
 ...
 */
export declare function deleteCheckoutKey(token: string, fingerprint: string, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<DeleteCheckoutKeyResponse>;
