 ...
 */
export declare function getBuildArtifacts(token: string, buildNumber: number, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<ArtifactResponse>;
/**
 ...
 * @param circleHost Provide custom url for CircleCI
 */
export declare function getLatestArtifacts(token: string, { vcs, options, circleHost }: GitRequiredRequest, customHeaders?: any): Promise<ArtifactResponse>;
