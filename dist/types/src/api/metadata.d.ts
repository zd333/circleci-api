import { GitInfo, TestMetadataResponse, CircleOptions } from "../types";
/**
 ...
 */
export declare function getTestMetadata(token: string, buildNumber: number, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<TestMetadataResponse>;
