 ...
 */
export declare function postBuildActions(token: string, buildNumber: number, action: BuildAction, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<BuildActionResponse>;
/**
 ...
 */
export declare function postTriggerNewBuild(token: string, { circleHost, vcs, options: { branch, newBuildOptions }, }: GitRequiredRequest, customHeaders?: any): Promise<TriggerBuildResponse>;
