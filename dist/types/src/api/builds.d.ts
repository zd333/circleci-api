 ...
 */
export declare function getRecentBuilds(token: string, { limit, offset, circleHost }?: Options & CircleOptions, customHeaders?: any): Promise<BuildSummaryResponse>;
/**
 ...
 */
export declare function getBuildSummaries(token: string, { vcs, options, circleHost }: GitRequiredRequest, customHeaders?: any): Promise<BuildSummaryResponse>;
/**
 ...
 */
export declare function getFullBuild(token: string, buildNumber: number, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<FetchBuildResponse>;
