import { ClearCacheResponse, GitInfo, CircleOptions } from "../types";
/**
 * Clear project cache
 *
 ...
 */
export declare function clearCache(token: string, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<ClearCacheResponse>;
