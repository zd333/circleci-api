 ...
 */
export declare function listEnv(token: string, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<ListEnvVariablesResponse>;
/**
 ...
 */
export declare function addEnv(token: string, payload: EnvVariable, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<EnvVariableResponse>;
/**
 ...
 */
export declare function getEnv(token: string, envName: string, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<EnvVariableResponse>;
/**
 ...
 */
export declare function deleteEnv(token: string, envName: string, { circleHost, ...vcs }: GitInfo & CircleOptions, customHeaders?: any): Promise<DeleteEnvVarResponse>;
