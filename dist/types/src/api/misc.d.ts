 ...
 */
export declare function addSSHKey(token: string, vcs: GitInfo, key: SSHKey, { circleHost }?: CircleOptions, customHeaders?: any): Promise<AddSSHKeyResponse>;
/**
 ...
 * @returns nothing unless error
 */
export declare function addHerokuKey(token: string, key: HerokuKey, { circleHost }?: CircleOptions, customHeaders?: any): Promise<AddHerokuResponse>;
