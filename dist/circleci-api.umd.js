(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.circleciApi = {}));
  ...
  ***************************************************************************** */
  ...
  function addUserAgentHeader(_a) {
      ...
      return __assign(__assign({}, config), { headers: __assign(__assign({}, headers), { "User-Agent": organization + "/" + name + " " + version$1 }) });
  }
  ...
  */
  ...
  var CircleCI = /** @class */ (function () {
      ...
      CircleCI.prototype.retry = function (build, opts) {
          return this.performAction(__assign(__assign({}, this.createRequest(opts)), this.circleOptions), build, exports.BuildAction.RETRY);
      };
      /**
      ...
      CircleCI.prototype.cancel = function (build, opts) {
          return this.performAction(__assign(__assign({}, this.createRequest(opts)), this.circleOptions), build, exports.BuildAction.CANCEL);
      };
      /**
       * Triggers a new build, returns a summary of the build.
       * @see https://circleci.com/docs/api/v1-reference/#new-build
  ...
  exports.CircleCIFactory = client;
