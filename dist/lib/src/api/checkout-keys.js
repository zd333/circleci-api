...
exports.deleteCheckoutKey = exports.getCheckoutKey = exports.createCheckoutKey = exports.getCheckoutKeys = void 0;
...
function getCheckoutKeys(token, _a, customHeaders) {
    ...
    return client_1.client(token, circleHost, customHeaders).get(createUrl(vcs));
}
...
function createCheckoutKey(token, key, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client_1.client(token, circleHost, customHeaders).post(createUrl(vcs), key, util_1.createJsonHeader());
}
...
function getCheckoutKey(token, fingerprint, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client_1.client(token, circleHost, customHeaders).get(createUrl(vcs, fingerprint));
}
...
function deleteCheckoutKey(token, fingerprint, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client_1.client(token, circleHost, customHeaders).delete(createUrl(vcs, fingerprint));
}
