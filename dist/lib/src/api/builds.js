...
exports.getFullBuild = exports.getBuildSummaries = exports.getRecentBuilds = void 0;
...
function getRecentBuilds(token, _a, customHeaders) {
    ...
    return client_1.client(token, circleHost, customHeaders).get(url);
}
...
function getBuildSummaries(token, _a, customHeaders) {
    ...
    return client_1.client(token, circleHost, customHeaders).get("" + url + params);
}
