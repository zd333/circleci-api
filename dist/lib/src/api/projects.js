...
exports.postFollowNewProject = exports.getAllProjects = void 0;
...
function getAllProjects(token, _a, customHeaders) {
    ...
    return client_1.client(token, circleHost, customHeaders).get(types_1.API_ALL_PROJECTS);
}
...
function postFollowNewProject(token, _a, customHeaders) {
    ...
    var url = types_1.createVcsUrl(vcs) + "/follow";
    return client_1.client(token, circleHost, customHeaders).post(url);
}
