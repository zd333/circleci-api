...
exports.deleteEnv = exports.getEnv = exports.addEnv = exports.listEnv = void 0;
...
function addEnv(token, payload, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client_1.client(token, circleHost, customHeaders).post(createUrl(vcs), payload, util_1.createJsonHeader());
}
...
function getEnv(token, envName, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client_1.client(token, circleHost, customHeaders).get(createUrl(vcs, envName));
}
...
function deleteEnv(token, envName, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client_1.client(token, circleHost, customHeaders).delete(createUrl(vcs, envName));
}
