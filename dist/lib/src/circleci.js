...
var CircleCI = /** @class */ (function () {
    ...
    CircleCI.prototype.followProject = function (opts) {
        ...
        return projects_1.postFollowNewProject(token, __assign(__assign({}, rest), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.recentBuilds = function (reqOptions, opts) {
        ...
        return builds_1.getRecentBuilds(token, __assign(__assign({}, options), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.builds = function (reqOptions, opts) {
        ...
        return builds_1.getBuildSummaries(token, __assign(__assign({}, rest), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.build = function (buildNumber, opts) {
        ...
        return builds_1.getFullBuild(token, buildNumber, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.artifacts = function (buildNumber, opts) {
        ...
        return artifacts_1.getBuildArtifacts(token, buildNumber, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.latestArtifacts = function (reqOptions, opts) {
        ...
        return artifacts_1.getLatestArtifacts(token, __assign(__assign({}, rest), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.retry = function (build, opts) {
        return this.performAction(__assign(__assign({}, this.createRequest(opts)), this.circleOptions), build, types_1.BuildAction.RETRY);
    };
    /**
    ...
    CircleCI.prototype.cancel = function (build, opts) {
        return this.performAction(__assign(__assign({}, this.createRequest(opts)), this.circleOptions), build, types_1.BuildAction.CANCEL);
    };
    /**
    ...
    CircleCI.prototype.triggerBuild = function (opts) {
        var _a = this.createRequest(opts), token = _a.token, rest = __rest(_a, ["token"]);
        return api_1.postTriggerNewBuild(token, __assign(__assign({}, rest), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.triggerBuildFor = function (branch, opts) {
        ...
        return api_1.postTriggerNewBuild(token, __assign(__assign({}, request), this.circleOptions));
    };
    /*
     * Cache
     */
    ...
    CircleCI.prototype.clearCache = function (opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return cache_1.clearCache(token, __assign(__assign({}, vcs), this.circleOptions));
    };
    /*
    ...
    CircleCI.prototype.listEnvVars = function (opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return env_1.listEnv(token, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.addEnvVar = function (variable, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return env_1.addEnv(token, variable, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.getEnvVar = function (envName, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return env_1.getEnv(token, envName, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.deleteEnvVar = function (envName, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return env_1.deleteEnv(token, envName, __assign(__assign({}, vcs), this.circleOptions));
    };
    /*
     * Checkout Keys
     */
    ...
    CircleCI.prototype.listCheckoutKeys = function (opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return checkout_keys_1.getCheckoutKeys(token, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.addCheckoutKey = function (type, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return checkout_keys_1.createCheckoutKey(token, { type: type }, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.getCheckoutKey = function (fingerprint, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return checkout_keys_1.getCheckoutKey(token, fingerprint, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.deleteCheckoutKey = function (fingerprint, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return checkout_keys_1.deleteCheckoutKey(token, fingerprint, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.getTestMetadata = function (buildNumber, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return metadata_1.getTestMetadata(token, buildNumber, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.performAction = function (request, build, action) {
        ...
        return api_1.postBuildActions(token, build, action, __assign(__assign({}, vcs), { circleHost: circleHost }));
    };
    return CircleCI;
}());
