...
var name$1 = "circleci-api";
var version$1 = "1.0.0";
var organization = "worldturtlemedia";
...
function addUserAgentHeader(_a) {
    ...
    return __assign(__assign({}, config), { headers: __assign(__assign({}, headers), { "User-Agent": organization + "/" + name$1 + " " + version$1 }) });
}
 ...
 */
function client(token, circleHost, headers) {
    var _this = this;
    if (circleHost === void 0) { circleHost = API_BASE; }
    var baseOptions = headers
        ? { headers: headers, baseURL: circleHost }
        : { baseURL: circleHost };
    var factory = {
        get: function (url, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            config = addUserAgentHeader(mergeOptions(baseOptions, options));
                            return [4 /*yield*/, get(token, url, config)];
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            config = addUserAgentHeader(mergeOptions(baseOptions, options));
                            return [4 /*yield*/, post(token, url, body, config)];
                        case 1: return [2 /*return*/, (_a.sent()).data];
                    }
                });
            });
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            config = addUserAgentHeader(mergeOptions(baseOptions, options));
                            return [4 /*yield*/, doDelete(token, url, config)];
                        case 1: return [2 /*return*/, (_a.sent()).data];
                    }
                });
            });
...
function mergeOptions(base, provided) {
    return __assign(__assign({}, base), provided);
}
 ...
 */
function postBuildActions(token, buildNumber, action, _a, customHeaders) {
 ...
 */
function postTriggerNewBuild(token, _a, customHeaders) {
    ...
    return client(token, circleHost, customHeaders).post(url, newBuildOptions);
}
 ...
 */
function getBuildArtifacts(token, buildNumber, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    var url = createVcsUrl(vcs) + "/" + buildNumber + "/artifacts";
    return client(token, circleHost, customHeaders).get(url);
}
/**
 ...
 * @param circleHost Provide custom url for CircleCI
 */
function getLatestArtifacts(token, _a, customHeaders) {
 ...
 */
function getRecentBuilds(token, _a, customHeaders) {
 ...
 */
function getBuildSummaries(token, _a, customHeaders) {
    var vcs = _a.vcs, _b = _a.options, options = _b === void 0 ? {} : _b, circleHost = _a.circleHost;
    ...
    return client(token, circleHost, customHeaders).get("" + url + params);
}
/**
 ...
 */
function getFullBuild(token, buildNumber, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
 ...
 */
function getAllProjects(token, _a, customHeaders) {
    var circleHost = (_a === void 0 ? {} : _a).circleHost;
    return client(token, circleHost, customHeaders).get(API_ALL_PROJECTS);
}
/**
 ...
 */
function postFollowNewProject(token, _a, customHeaders) {
 ...
 */
function clearCache(token, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
 ...
 */
function getCheckoutKeys(token, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client(token, circleHost, customHeaders).get(createUrl(vcs));
}
/**
 ...
 */
function createCheckoutKey(token, key, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client(token, circleHost, customHeaders).post(createUrl(vcs), key, createJsonHeader());
}
/**
 ...
 * @returns list of checkout keys for a specific project
 */
function getCheckoutKey(token, fingerprint, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client(token, circleHost, customHeaders).get(createUrl(vcs, fingerprint));
}
/**
 ...
 */
function deleteCheckoutKey(token, fingerprint, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client(token, circleHost, customHeaders).delete(createUrl(vcs, fingerprint));
}
/**
 ...
 */
function listEnv(token, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client(token, circleHost, customHeaders).get(createUrl$1(vcs));
}
/**
 ...
 */
function addEnv(token, payload, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client(token, circleHost, customHeaders).post(createUrl$1(vcs), payload, createJsonHeader());
}
/**
 ...
 */
function getEnv(token, envName, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client(token, circleHost, customHeaders).get(createUrl$1(vcs, envName));
}
/**
 ...
 */
function deleteEnv(token, envName, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
    return client(token, circleHost, customHeaders).delete(createUrl$1(vcs, envName));
}
/**
 ...
 */
function getTestMetadata(token, buildNumber, _a, customHeaders) {
    var circleHost = _a.circleHost, vcs = __rest(_a, ["circleHost"]);
 ...
 */
function addSSHKey(token, vcs, key, _a, customHeaders) {
    var circleHost = (_a === void 0 ? {} : _a).circleHost;
    var url = createVcsUrl(vcs) + "/ssh-key";
    return client(token, circleHost, customHeaders).post(url, key);
}
/**
 ...
 * @returns nothing unless error
 */
function addHerokuKey(token, key, _a, customHeaders) {
    var circleHost = (_a === void 0 ? {} : _a).circleHost;
...
function getMe(token, _a, customHeaders) {
    var circleHost = (_a === void 0 ? {} : _a).circleHost;
    return client(token, circleHost, customHeaders).get(API_ME);
}
...
var CircleCI = /** @class */ (function () {
    ...
    function CircleCI(_a) {
        var token = _a.token, _b = _a.vcs, _c = _b === void 0 ? {} : _b, _d = _c.type, type = _d === void 0 ? GitType.GITHUB : _d, _e = _c.owner, owner = _e === void 0 ? "" : _e, _f = _c.repo, repo = _f === void 0 ? "" : _f, _g = _a.options, options = _g === void 0 ? {} : _g, circleHost = _a.circleHost;
        this.token = token;
    ...
    CircleCI.prototype.followProject = function (opts) {
        ...
        return postFollowNewProject(token, __assign(__assign({}, rest), this.circleOptions));
    };
    /**
     * Get all recent builds for CircleCI user
    ...
    CircleCI.prototype.recentBuilds = function (reqOptions, opts) {
        ...
        var _a = this.createRequest(__assign(__assign({}, (opts || {})), { options: __assign(__assign({}, (opts ? opts.options : {})), reqOptions) })), token = _a.token, options = _a.options;
        return getRecentBuilds(token, __assign(__assign({}, options), this.circleOptions));
    };
    /**
     * Get recent build summaries for a project
    ...
    CircleCI.prototype.builds = function (reqOptions, opts) {
        var _a = this.createRequest(__assign(__assign({}, (opts || {})), { options: __assign(__assign({}, (opts ? opts.options : {})), (reqOptions || {})) })), token = _a.token, rest = __rest(_a, ["token"]);
        return getBuildSummaries(token, __assign(__assign({}, rest), this.circleOptions));
    };
    /**
     * Get recent builds for a project and branch
    ...
    CircleCI.prototype.buildsFor = function (branch, reqOptions, opts) {
        ...
        if (reqOptions === void 0) { reqOptions = {}; }
        var _a = this.createRequest(__assign(__assign({}, opts), { options: __assign(__assign(__assign({}, (opts ? opts.options : {})), reqOptions), { branch: branch }) })), token = _a.token, rest = __rest(_a, ["token"]);
        return getBuildSummaries(token, __assign(__assign({}, rest), this.circleOptions));
    };
    /**
     * Get full build details for a single build
    ...
    CircleCI.prototype.build = function (buildNumber, opts) {
        var _a = this.createRequest(__assign(__assign({}, (opts || {})), { options: __assign({}, (opts ? opts.options : {})) })), token = _a.token, vcs = _a.vcs;
        return getFullBuild(token, buildNumber, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
     * Get artifacts for single project build
     * @param buildNumber Target build number
    ...
    CircleCI.prototype.artifacts = function (buildNumber, opts) {
        ...
        return getBuildArtifacts(token, buildNumber, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
     * Get the latest build artifacts for a project
    ...
    CircleCI.prototype.latestArtifacts = function (reqOptions, opts) {
        if (opts === void 0) { opts = {}; }
        var _a = this.createRequest(__assign(__assign({}, opts), { options: __assign(__assign({}, opts.options), (reqOptions || {})) })), token = _a.token, rest = __rest(_a, ["token"]);
        return getLatestArtifacts(token, __assign(__assign({}, rest), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.retry = function (build, opts) {
        return this.performAction(__assign(__assign({}, this.createRequest(opts)), this.circleOptions), build, BuildAction.RETRY);
    };
    /**
    ...
    CircleCI.prototype.cancel = function (build, opts) {
        return this.performAction(__assign(__assign({}, this.createRequest(opts)), this.circleOptions), build, BuildAction.CANCEL);
    };
    /**
     * Triggers a new build, returns a summary of the build.
     * @see https://circleci.com/docs/api/v1-reference/#new-build
    ...
    CircleCI.prototype.triggerBuild = function (opts) {
        var _a = this.createRequest(opts), token = _a.token, rest = __rest(_a, ["token"]);
        return postTriggerNewBuild(token, __assign(__assign({}, rest), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.triggerBuildFor = function (branch, opts) {
        if (branch === void 0) { branch = "master"; }
        var _a = this.createRequest(__assign(__assign({}, opts), { options: __assign(__assign({}, (opts ? opts.options : {})), { branch: branch }) })), token = _a.token, request = __rest(_a, ["token"]);
        return postTriggerNewBuild(token, __assign(__assign({}, request), this.circleOptions));
    };
    /*
     * Cache
     */
    ...
    CircleCI.prototype.clearCache = function (opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return clearCache(token, __assign(__assign({}, vcs), this.circleOptions));
    };
    /*
    ...
    CircleCI.prototype.listEnvVars = function (opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return listEnv(token, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
     * Add environment variable to project
     * @see addEnv
    ...
    CircleCI.prototype.addEnvVar = function (variable, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return addEnv(token, variable, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.getEnvVar = function (envName, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return getEnv(token, envName, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.deleteEnvVar = function (envName, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return deleteEnv(token, envName, __assign(__assign({}, vcs), this.circleOptions));
    };
    /*
     * Checkout Keys
     */
    ...
    CircleCI.prototype.listCheckoutKeys = function (opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return getCheckoutKeys(token, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.addCheckoutKey = function (type, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return createCheckoutKey(token, { type: type }, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
     * Get a single checkout key from it's fingerprint
     * @see getCheckoutKey
    ...
    CircleCI.prototype.getCheckoutKey = function (fingerprint, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return getCheckoutKey(token, fingerprint, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.deleteCheckoutKey = function (fingerprint, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return deleteCheckoutKey(token, fingerprint, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
    ...
    CircleCI.prototype.getTestMetadata = function (buildNumber, opts) {
        var _a = this.createRequest(opts), token = _a.token, vcs = _a.vcs;
        return getTestMetadata(token, buildNumber, __assign(__assign({}, vcs), this.circleOptions));
    };
    /**
     * Creates an ssh key that will be used to access the external system identified by
     * the hostname parameter for SSH key-based authentication.
    ...
    CircleCI.prototype.createRequest = function (opts) {
        ...
        var request = {
            ...
            options: __assign(__assign({}, this.options), opts.options),
            vcs: __assign(__assign({}, this.vcs), opts.vcs)
        };
    ...
    CircleCI.prototype.performAction = function (request, build, action) {
        ...
        return postBuildActions(token, build, action, __assign(__assign({}, vcs), { circleHost: circleHost }));
    };
    return CircleCI;
}());

export { API_ALL_PROJECTS, API_BASE, API_ME, API_PROJECT, API_RECENT_BUILDS, API_USER, BuildAction, CircleCI, client as CircleCIFactory, GitType, addEnv, addHerokuKey, addSSHKey, clearCache, createCheckoutKey, createVcsUrl, deleteCheckoutKey, deleteEnv, getAllProjects, getBuildArtifacts, getBuildSummaries, getCheckoutKey, getCheckoutKeys, getEnv, getFullBuild, getGitType, getLatestArtifacts, getMe, getRecentBuilds, getTestMetadata, listEnv, postBuildActions, postFollowNewProject, postTriggerNewBuild };
//# sourceMappingURL=circleci-api.es5.js.map
